...
if (!$SITE_RAIZ || $SITE_RAIZ = !$PHP_SELF || in_array($ALUNO, $_SESSION["loginTipo"])) {
    ...
    $SITE = 'view/common/bolsas/bolsaAluno.php';
    $TITLE = 'Alunos';
    $TITLE_DESCRICAO = "<span class=\"help\"><a title='Sobre esse m&oacute;dulo' data-content=\"Cadastra um ou mais alunos para uma bolsa de ensino.\" href=\"#\"><img src=\"" . ICONS . "/help.png\"></a></span>";
}
...
<table id="listagem" border="0" align="center">
    ...
    foreach ($res as $reg) {
        ...
        <tr <?= $cdif ?>><td align='center'><?= $i ?></td>
            <td><a href="#" data-placement="top" data-content='<?= $reg['titulo'] ?>' title="Bolsa"><?= abreviar(mostraTexto($reg['titulo']), 40) ?></a></td>
            <td><a href="#" data-placement="top" data-content='<?= $reg['aluno'] ?>' title="Aluno"><?= abreviar(mostraTexto($reg['aluno']), 40) ?></a></td>
            <td align='left'>
