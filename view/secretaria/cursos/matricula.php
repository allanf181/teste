...
//Habilita tela onde aparece uma lista com a situação do aluno com relação a todas as disciplinas cursadas por ele em determinado módulo do curso que ele frequenta.
 ...
 <form>
    ...
    if ($resultado) {
        while ($linha = mysql_fetch_array($resultado)) {
            ...
            print "<tr $cdif ><td align='left'>$linha[0]</td><td>".mostraTexto($linha[1])."</td><td align='left'><a class='tooltip' target='_blank' href='relatorios/diarioProfessor.php?atribuicao=".crip($linha[7])."' title='$bimestre $linha[5] $grupo | $professor'>$linha[2] [$linha[13]] $linha[8] $grupo</a></td>\n";
