...
//Habilita tela em que é possível a visualização do calendário do ano letivo corrente do Campus.
		...
		print "<tbody>\n";
          ...
          for ($i=1,$d=1;$d<=$Dias;) {
               ...
               for ($x=1;$x<=7 && $d <= $Dias;$x++,$i++) {
                    ...
                    else { echo("<td class='calendario'> </td>"); }
                   
               }
               for (;$x<=7;$x++) { echo("<td class='calendario'> </td>"); }
               echo("</tr>");
               $n++;
           }
