            ...
            <div class="cont_tab" id="Dados3">
                <table width="772" border="0">
                    <tr>
                        ...
                        <td width="215"><select style="width:200px;" id="estadoCivil" name="estadoCivil" value="<?php echo $estadoCivil; ?>">
                                <option value="">N&atilde;o declarado</option>
                                <?php
                                require CONTROLLER . "/estadoCivil.class.php";
                                $ec = new EstadosCivis();
                                foreach ($ec->listRegistros(null, null, null, ' ORDER BY nome ') as $reg) {
                                    $selected = "";
                        ...
                        <td width="215"><select style="width:200px;" <?php if ($NOT_PERM) print "disabled"; ?> id="sexo" name="sexo" value="<?php echo $sexo; ?>">
                                <option value=""></option>
                                <?php
                                require CONTROLLER . "/sexo.class.php";
                                $s = new Sexos();
                                foreach ($s->listRegistros(null, null, null, ' ORDER BY nome ') as $reg) {
                                    $selected = "";
                                    if ($reg['codigo'] == $sexo)
                                        $selected = "selected";
                                    echo "<option $selected value='" . crip($reg['codigo']) . "'>" . $reg['nome'] . "</option>";
                    ...
                    <tr>
                        ...
                        <td><select id="renda" style="width:200px;" name="renda" value="<?php echo $renda; ?>">
                                <option value="">N&atilde;o declarado</option>
                                <?php
                                require CONTROLLER . "/renda.class.php";
                                $r = new Rendas();
                                foreach ($r->listRegistros(null, null, null, ' ORDER BY nome ') as $reg) {
                                    $selected = "";
                                    if ($reg['codigo'] == $sexo)
                                        $selected = "selected";
                                    echo "<option $selected value='" . crip($reg['codigo']) . "'>" . $reg['nome'] . "</option>";
                        ...
                        <td><select id="raca" style="width:200px;" name="raca" value="<?php echo $raca; ?>">
                                <option value=""></option>
                                <?php
                                require CONTROLLER . "/raca.class.php";
                                $rc = new Racas();
                                foreach ($rc->listRegistros(null, null, null, ' ORDER BY nome ') as $reg) {
                                    $selected = "";
                                    if ($reg['codigo'] == $sexo)
                                        $selected = "selected";
                                    echo "<option $selected value='" . crip($reg['codigo']) . "'>" . $reg['nome'] . "</option>";
                    ...
                    <tr>
                        ...
                        <td><select id="situacaoTrabalho" style="width:200px;" name="situacaoTrabalho" value="<?php echo $situacaoTrabalho; ?>">
                                <option value="">N&atilde;o declarado</option>
                                <?php
                                require CONTROLLER . "/situacaoTrabalho.class.php";
                                $st = new SituacoesTrabalho();
                                foreach ($st->listRegistros(null, null, null, ' ORDER BY nome ') as $reg) {
                                    $selected = "";
                        ...
                        <td><select id="tempo" style="width:200px;" name="tempo" value="<?php echo $tempo; ?>">
                                <option value="">N&atilde;o declarado</option>
                                <?php
                                require CONTROLLER . "/tempoPesquisa.class.php";
                                $tp = new TemposPesquisa();
                                foreach ($tp->listRegistros(null, null, null, ' ORDER BY nome ') as $reg) {
                                    $selected = "";
                                    if ($reg['codigo'] == $tempo)
                                        $selected = "selected";
                                    echo "<option $selected value='" . crip($reg['codigo']) . "'>" . $reg['nome'] . "</option>";
                    ...
                    <tr>
                        ...
                        <td><select id="tipoTrabalho" style="width:200px;" name="tipoTrabalho" value="<?php echo $tipoTrabalho; ?>">
                                <option value="">N&atilde;o declarado</option>
                                <?php
                                require CONTROLLER . "/tipoTrabalho.class.php";
                                $tt = new TiposTrabalho();
                                foreach ($tt->listRegistros(null, null, null, ' ORDER BY nome ') as $reg) {
                                    $selected = "";
                                    if ($reg['codigo'] == $tempo)
                                        $selected = "selected";
                                    echo "<option $selected value='" . crip($reg['codigo']) . "'>" . $reg['nome'] . "</option>";
                    ...
                    <tr>
                        ...
                        <td><select id="meioTransporte" style="width:200px;" name="meioTransporte" value="<?php echo $meioTransporte; ?>">
                                <option value="">N&atilde;o declarado</option>
                                <?php
                                require CONTROLLER . "/meioTransporte.class.php";
                                $mt = new MeiosTransporte();
                                foreach ($mt->listRegistros(null, null, null, ' ORDER BY nome ') as $reg) {
                                    $selected = "";
                                    if ($reg['codigo'] == $tempo)
                                        $selected = "selected";
                                    echo "<option $selected value='" . crip($reg['codigo']) . "'>" . $reg['nome'] . "</option>";
                        ...
                        <td><select id="necessidadesEspeciais" style="width:200px;" name="necessidadesEspeciais" value="<?php echo $necessidadesEspeciais; ?>">
                                <option value="">N&atilde;o declarado</option>
                    ...
                    <tr>
                        ...
                        <td><select id="transporteGratuito" name="transporteGratuito" value="<?php echo $transporteGratuito; ?>">
                                <option value="">N&atilde;o declarado</option>
                    ...
                    <tr>
                        ...
                        <td><input type="text" <?php if ($NOT_PERM) print "readonly"; ?> size="10" name="ano1g" maxlength="4" value="<?php echo $ano1g; ?>"/></td>
                        <td align="right">Escola 1G: </td>
                        <td><input type="text" <?php if ($NOT_PERM) print "readonly"; ?> size="20" name="escola1g" maxlength="145" value="<?php echo $escola1g; ?>"/></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td><td>&nbsp;</td><td align="right">Escola P&uacute;blica: </td>
                        <td><select id="escolaPublica" name="escolaPublica" value="<?php echo $escolaPublica; ?>">
                                <option value="">N&atilde;o declarado</option>
