...
if ( mysql_num_rows($result) != '') {
    ...
    if ( (mysql_result($result, $i, "m.codigo") < 1000 || mysql_result($result, $i, "m.codigo") >= 2000) && !mysql_result($result, $i, "c.nomeAlternativo")) $curso = mysql_result($result, $i, "m.nome").' - '.mysql_result($result, $i, "c.nome");
		...
		if ($fechamento == 'a') $bimestreEsemestre = 'ANUAL';
		if ($fechamento == 'b') $bimestreEsemestre = $bimestre."º BIM / $semestre";
		if ($fechamento == 's') $bimestreEsemestre = $semestre;
