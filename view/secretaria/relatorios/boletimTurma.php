...
//Habilita tela em que o docente é possível visualizar todas as notas de todos os módulos dos alunos que fazem parte dela.
  ...
  if ($('#maximizar').text()=='restaurar')
        ...
        $sql = "SELECT t.codigo, t.numero, c.nome, c.fechamento, m.nome, m.codigo 
          ...
          if (mysql_num_rows($resultado)){
              ...
              while ($linha = mysql_fetch_array($resultado)) {
                  ...
                  if ($linha[5] < 1000 || $linha[5] >= 2000) $linha[2] = "$linha[2] [$linha[4]]";
    ...
    <tr><td align="right">Bimestre: </td><td>
            <select name="campoBimestre" id="campoBimestre">
                ...
                <option <?php if ($bimestre=='final') echo "selected='selected'"; else echo ""; ?> value="<?=crip('final')?>">Final</option>
            </select>
        </td>
    </tr>
	<?php } ?>
...
if (!empty($_GET["turma"])) {
    ...
    if ($status) print "<font color=\"red\">N&atilde;o &eacute; poss&iacute;vel alterar a situa&ccedil;&atilde;o com di&aacute;rios abertos.</font><br>\n"; 
