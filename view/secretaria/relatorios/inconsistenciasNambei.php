...
//Relatório em que é possível visualizar os problemas de inconsistências entre dados de professores e o Nambei.
...
$sqlAdicional .= " AND (l.origem = 'CRON_NTDIV' OR l.origem = 'CRON_NTERR') ORDER BY DATE_FORMAT(data,'%d-%m-%Y') DESC, url ASC ";
