...
//Habilita tela em que é possível visualizar os dados importados das cidades cadastradas na base de dados do Nambei.
...
<?php
	...
	$SITENAV = "$SITE?";
	if ($restricao) $SITENAV = $SITE."?estado=".crip($estado);
