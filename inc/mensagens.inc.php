...
//    $INFO_UPDATE = 'Esse registro já está cadastrado no banco de dados ou nenhum valor foi alterado.';
    ...
    $NOK_FALSE_CLOSE_CLASS_REGISTRY = 'O di&aacute;rio n&atilde;o pode ser finalizado. Verifique se:'
            . '<br>- o n&uacute;mero m&iacute;nimo de avalia&ccedil;&otilde;es foi aplicado.'
            . '<br>- a carga hor&aacute;ria foi cumprida.'
            . '<br>- o Roda foi executado para seu di&aacute;rio. ';

    $NOT_SELECT = "Nenhum registro selecionado.";

    $OK_VALID_FTD = $OPT . ' validou sua FTD.';
    $OK_FINISH_FTD = 'FTD finalizada, aguardando valida&ccedil;&atilde;o do coordenador.';
    ...
    $OK_FINISH_FORM = 'Formul&aacute;rio finalizado, aguardando valida&ccedil;&atilde;o do respons&aacute;vel.';
    ...
    $INFO_STATUS_DIARIO_100 = "Esse di&aacute;rio ainda n&atilde;o come&ccedil;ou!<br>Ele ser&aacute; desbloqueado em ".$OPT;
