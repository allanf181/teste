...
class Academico50 extends Ruckusing_Migration_Base {
    ...
    public function up() {
        ...
        if ($result) {
            ...
            $this->execute("UPDATE `academico`.`Permissoes` SET `permissao` = 'view/secretaria/relatorios/atendimento.php,view/secretaria/relatorios/ausencias.php,view/secretaria/relatorios/boletim.php,view/secretaria/relatorios/boletimTurma.php,view/secretaria/relatorios/frequencias.php,view/secretaria/relatorios/listagem.php,view/secretaria/bolsas/bolsa.php,view/secretaria/bolsas/bolsaAluno.php,view/secretaria/bolsas/bolsaDisciplina.php,view/secretaria/bolsas/bolsaRelatorio.php,view/secretaria/aviso.php,view/secretaria/calendario.php,view/secretaria/ocorrencia.php,view/secretaria/socioEconomico.php,view/admin/usoSistema.php', `nome` = 'Atendimento ao Aluno,Aus&ecirc;ncias,Boletim do Aluno,Boletim Turma,Frequ&ecirc;ncias,Relat&oacute;rios (em PDF),Bolsas,Alunos,Disciplinas,Relat&oacute;rios,Avisos,Calend&aacute;rio,Ocorr&ecirc;ncias,Socioecon&ocirc;mico,Uso do Sistema', `menu` = 'view/secretaria/relatorios/atendimento.php,view/secretaria/relatorios/ausencias.php,view/secretaria/relatorios/boletim.php,view/secretaria/relatorios/boletimTurma.php,view/secretaria/relatorios/frequencias.php,view/secretaria/relatorios/listagem.php,view/secretaria/bolsas/bolsa.php,view/secretaria/bolsas/bolsaAluno.php,view/secretaria/bolsas/bolsaDisciplina.php,view/secretaria/bolsas/bolsaRelatorio.php,view/secretaria/aviso.php,view/secretaria/calendario.php,view/secretaria/ocorrencia.php,view/secretaria/socioEconomico.php,view/admin/usoSistema.php' WHERE `Permissoes`.`tipo` = " . $result[0]['codigo']);
        } else {
            ...
            $this->execute("INSERT INTO `Permissoes` (`codigo`, `tipo`, `permissao`, `nome`, `menu`) VALUES
                            (NULL, $codSSP, 'view/secretaria/relatorios/atendimento.php,view/secretaria/relatorios/ausencias.php,view/secretaria/relatorios/boletim.php,view/secretaria/relatorios/boletimTurma.php,view/secretaria/relatorios/frequencias.php,view/secretaria/relatorios/listagem.php,view/secretaria/bolsas/bolsa.php,view/secretaria/bolsas/bolsaAluno.php,view/secretaria/bolsas/bolsaDisciplina.php,view/secretaria/bolsas/bolsaRelatorio.php,view/secretaria/aviso.php,view/secretaria/calendario.php,view/secretaria/ocorrencia.php,view/secretaria/socioEconomico.php,view/admin/usoSistema.php', 'Atendimento ao Aluno,Aus&ecirc;ncias,Boletim do Aluno,Boletim Turma,Frequ&ecirc;ncias,Relat&oacute;rios (em PDF),Bolsas,Alunos,Disciplinas,Relat&oacute;rios,Avisos,Calend&aacute;rio,Ocorr&ecirc;ncias,Socioecon&ocirc;mico,Uso do Sistema', 'view/secretaria/relatorios/atendimento.php,view/secretaria/relatorios/ausencias.php,view/secretaria/relatorios/boletim.php,view/secretaria/relatorios/boletimTurma.php,view/secretaria/relatorios/frequencias.php,view/secretaria/relatorios/listagem.php,view/secretaria/bolsas/bolsa.php,view/secretaria/bolsas/bolsaAluno.php,view/secretaria/bolsas/bolsaDisciplina.php,view/secretaria/bolsas/bolsaRelatorio.php,view/secretaria/aviso.php,view/secretaria/calendario.php,view/secretaria/ocorrencia.php,view/secretaria/socioEconomico.php,view/admin/usoSistema.php')
                            ");
        }
