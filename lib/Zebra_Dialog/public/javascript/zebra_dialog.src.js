    ...
    $.Zebra_Dialog = function() {
        ...
        plugin.init = function() {
            ...
            if (plugin.settings.type == 'prompt') {
                $('<div>').html('<textarea rows="2" cols="30" name="Zebra_valor" maxlength="200" id="Zebra_valor"></textarea>').appendTo(plugin.message);
            }
        ...
        plugin.close = function(caption) {
            ...
            // when the animation is complete
            function() {
                var Zebra_valor = $('#Zebra_valor').val();
                ...
                if (plugin.settings.onClose && typeof plugin.settings.onClose == 'function')
                    ...
                    plugin.settings.onClose(undefined !== caption ? caption : '', Zebra_valor);
