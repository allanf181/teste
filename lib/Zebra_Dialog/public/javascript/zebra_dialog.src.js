    ...
    $.Zebra_Dialog = function() {
        ...
        plugin.init = function() {
            ...
            if (plugin.settings.type == 'prompt') {
                $('<div>').html('<textarea rows="2" cols="30" name="valor" maxlength="200" id="valor"></textarea>').appendTo(plugin.message);
            }
        ...
        plugin.close = function(caption) {
            ...
            function() {
                ...
                if (plugin.settings.onClose && typeof plugin.settings.onClose == 'function')
                    ...
                    plugin.settings.onClose(undefined !== caption ? caption : '', valor);
